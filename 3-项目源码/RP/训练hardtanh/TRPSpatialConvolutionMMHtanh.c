...
#define TH_GENERIC_FILE "generic/TRPSpatialConvolutionMMHtanh.c"
#else

static inline void THNN_(TRPSpatialConvolutionMMHtanh_shapeCheck)(
...
static void THNN_(TRPSpatialConvolutionMMHtanh_Htanh)(
          THTensor *r,
          THTensor *t)
{
...
static void THNN_(TRPSpatialConvolutionMMHtanh_updateOutput_frame)(
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          THTensor *bias,
...
void THNN_(TRPSpatialConvolutionMMHtanh_updateOutput)(
          THNNState *state,
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          ...
          int padH)
{
  ...
  THNN_(TRPSpatialConvolutionMMHtanh_shapeCheck)
  ...
  if(input->nDimension == 3)
  {
    ...
    THNN_(TRPSpatialConvolutionMMHtanh_updateOutput_frame)
...
static void THNN_(TRPSpatialConvolutionMMHtanh_updateGradInput_frame)(
          THTensor *gradInput,
          THTensor *gradOutput,
...
void THNN_(TRPSpatialConvolutionMMHtanh_updateGradInput)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradInput,
...
//  the original put the tweight into the frame function as weight
  if(input->nDimension == 3)
  {
    ...
    THNN_(TRPSpatialConvolutionMMHtanh_updateGradInput_frame)(gradInput, gradOutput,
...
#pragma omp parallel for private(t)
    for(t = 0; t < T; t++)
    {
      ...
      THNN_(TRPSpatialConvolutionMMHtanh_updateGradInput_frame)(gradInput_t, gradOutput_t,
...
static void THNN_(TRPSpatialConvolutionMMHtanh_accGradParameters_frame)(
          THTensor *gradOutput,
          THTensor *gradWeight,
          THTensor *gradBias,
          THTensor *finput,
...
//
  ...
  THTensor *Biweight = THTensor_(new)();
  THTensor_(sign)(Biweight,Pweight);
  ...
  THNN_(TRPSpatialConvolutionMMHtanh_Htanh)(gradBiweight, Pweight);
...
//gradWeight gradient
  ...
  THTensor *tweight = THTensor_(new)();
  THTensor_(transpose)(tweight, weight, 0, 1);
  THTensor_(addmm)(gradProjection, 0, gradProjection, 1, tweight, gradBiweight);
  THTensor *tgradBinput = THTensor_(new)();
  THTensor_(transpose)(tgradBinput, gradBinput, 0, 1);
  THTensor_(addmm)(gradProjection, 1, gradProjection, 1, finput, tgradBinput);
...
void THNN_(TRPSpatialConvolutionMMHtanh_accGradParameters)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradWeight,
          ...
          real scale)
{
  ...
  {
    //
    THNN_(TRPSpatialConvolutionMMHtanh_accGradParameters_frame)(gradOutput, gradWeight,
              gradBias, finput, projection, gradProjection, weight, scale);
    //smz  
}
  else
  {
    ...
    for(t = 0; t < T; t++)
    {
      ...
      //
      THNN_(TRPSpatialConvolutionMMHtanh_accGradParameters_frame)(gradOutput_t, gradWeight,
                gradBias, finput_t, projection, gradProjection, weight, scale);
      //smz
