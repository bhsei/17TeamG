...
#define TH_GENERIC_FILE "generic/TRPSpatialConvolutionMM.c"
#else

static inline void THNN_(TRPSpatialConvolutionMM_shapeCheck)(
...
static void THNN_(TRPSpatialConvolutionMM_updateOutput_frame)(
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          THTensor *bias,
...
void THNN_(TRPSpatialConvolutionMM_updateOutput)(
          THNNState *state,
          THTensor *input,
          THTensor *output,
          THTensor *weight,
          ...
          int padH)
{
  ...
  THNN_(TRPSpatialConvolutionMM_shapeCheck)
  ...
  if(input->nDimension == 3)
  {
    ...
    THNN_(TRPSpatialConvolutionMM_updateOutput_frame)
...
static void THNN_(TRPSpatialConvolutionMM_updateGradInput_frame)(
          THTensor *gradInput,
          THTensor *gradOutput,
...
void THNN_(TRPSpatialConvolutionMM_updateGradInput)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradInput,
...
//  the original put the tweight into the frame function as weight
  if(input->nDimension == 3)
  {
    ...
    THNN_(TRPSpatialConvolutionMM_updateGradInput_frame)(gradInput, gradOutput,
...
#pragma omp parallel for private(t)
    for(t = 0; t < T; t++)
    {
      ...
      THNN_(TRPSpatialConvolutionMM_updateGradInput_frame)(gradInput_t, gradOutput_t,
...
static void THNN_(TRPSpatialConvolutionMM_accGradParameters_frame)(
          THTensor *gradOutput,
          THTensor *gradWeight,
          THTensor *gradBias,
          THTensor *finput,
...
void THNN_(TRPSpatialConvolutionMM_accGradParameters)(
          THNNState *state,
          THTensor *input,
          THTensor *gradOutput,
          THTensor *gradWeight,
          ...
          real scale)
{
  ...
  {
    //
    THNN_(TRPSpatialConvolutionMM_accGradParameters_frame)(gradOutput, gradWeight,
  ...
  else
  {
    ...
    for(t = 0; t < T; t++)
    {
      ...
      //
      THNN_(TRPSpatialConvolutionMM_accGradParameters_frame)(gradOutput_t, gradWeight,
