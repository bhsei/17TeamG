...
function Module:parameters()
   if self.weight and self.bias and self.tprojection then
      return {self.weight, self.bias, self.tprojection}, {self.gradWeight, self.gradBias, self.gradTprojection}
   elseif self.weight and self.bias then
      return {self.weight, self.bias}, {self.gradWeight, self.gradBias}
   elseif self.weight and self.tprojection then
      return {self.weight, self.tprojection}, {self.gradWeight, self.gradTprojection}
   elseif self.bias and self.tprojection then
      return {self.bias, self.tprojection}, {self.gradBias, self.gradTprojection}
   elseif self.weight then
      return {self.weight}, {self.gradWeight}
   elseif self.bias then
      return {self.bias}, {self.gradBias}
   elseif self.tprojection then
      return {self.tprojection}, {self.gradTprojection}    
   else
      return
   end
end
